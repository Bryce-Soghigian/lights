  ...
  return (
    <div>
      ...
      <StairsContianer>
        ...
        />
        <StairsPostButton
        onClick={() => updateLightColor(`http://localhost:5555/lights/stairs`,lightColorState.stairsColor)}
        >
          Change Lights
        </StairsPostButton>
      </StairsContianer>
      ...
      <LivingRoomCeilingContainer>
        ...
        />
        <CeilingPostButton
        onClick={() => updateLightColor(`http://localhost:5555/lights/livingroominceiling`, lightColorState.ceilingColor)}
        >
          Change Lights
        </CeilingPostButton>
      </LivingRoomCeilingContainer>
      <FloorContainer>
        ...
        />
        <FloorPostButton
        onClick={() => updateLightColor(`http://localhost:5555/lights/floor`,lightColorState.floorColor)}
        >
        Change Lights
        </FloorPostButton>
      </FloorContainer>
